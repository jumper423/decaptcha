...
+ [Documentation in English language](../docs/Socialink-en.md)
+ Якоря
  + [Ссылка](#Ссылка)
...
Ссылка
--------------
[Ссылка на сервис SociaLink](http://www.socialink.ru/?key=84333)

Описание сервиса
--------------
Распознавание капч, капчи на русском языке, в любое время суток, начисление заработка в онлайне
...
--------------
 ...
 Кириллица | ACTION_FIELD_IS_RUSSIAN | INTEGER | - | 0 |  | На изображении присутствуют русские символы |
